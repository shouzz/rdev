...
Device registration ownership and same-owner reenrollment are unchanged. Feidu independently authenticates each account and keeps enrollment claims, browser renewals, Agent sessions, cloud tasks and artifact ACLs scoped to their actual account.
